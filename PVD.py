...
class file_bits_reader:
    ...
    def __init__(self, secret_message):
        try:
            ...
            self.data = list(secret_message.encode())
            ...
            print("ERROR: Processing text data. EXCP: {}".format(e))
...
class pvd_lib:
    ...
    def embed_data(ref_image_path, secret_message, op_img_path):
    
        embedded_ds = 0
        
        bits_reader = file_bits_reader(secret_message)
    ...
    def extract_data(ref_image_path, s_file_path, pvd_img_path):
        embedded_ds = 0
